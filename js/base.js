...
function cambiarFuenteImagen(modo) {
    if (modo === 'oscuro') {
        iconFooter.src = 'img/logo1.png';
    } else {
        iconFooter.src = 'img/logo2.png';
    }
}
function cambiarFuentesImagenes(modo) {
    // Selecciona todas las imágenes con la clase "liga-img"
    var imagenes = document.querySelectorAll('.liga-img');

    // Itera sobre las imágenes y ajusta sus fuentes según el modo
...
if (checkDarkModeStatus === 1 || checkDarkModeStatus === "1") {
    ...
    cambiarFuenteImagen('oscuro');
    cambiarFuentesImagenes('oscuro');
    ...
    cambiarFuenteImagen('claro');
    cambiarFuentesImagenes('claro');
}
// Dark mode switch
